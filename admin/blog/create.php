        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h5 class="text-info">Create New Blog</h5>
                            <form action="model" class="mt-3" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" value="1" name="is_published" id="is_published" checked>
                                    <label for="is_published">Published</label>
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="create_blog" class="btn btn-primary" value="Create Blog">
                                </div>
                            </form>
                    </div>
                </div>
